...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.5dr26rn.mongodb.net/?retryWrites=true&w=majority`;
      ...
      try {
            ...
            app.put('/user/admin/:email', verifyJWT, async (req, res) => {
                  ...
                  if (requesterAccount.role === 'admin') {
                        ...
                        res.status(403).send({ message: 'Forbideddn' });
                  }
            ...
            app.get('/available', async (req, res) => {
                  ...
                  //       const available = service.slots.filter(service => !booked.includes(service));
             ...
             * app.get('/booking')// get all booking in this collection. or get more then one or by fillter
